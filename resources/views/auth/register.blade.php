<x-guest-layout>
    ...
    <style>
        ...
        .glass-icon-circle {
            ...
            color: #e5e7eb;
            margin-bottom: 24px;
            background: radial-gradient(circle at top, rgba(94, 234, 212, 0.35), rgba(15, 23, 42, 0.95));
            box-shadow:
        ...
        <div class="glass-card">
            <div class="glass-card-header">
                ...
                <div class="glass-tabs">
                    ...
                    <span class="glass-tab-active">Register</span>
                </div>
            </div>

            <div class="glass-title">Create</div>
            <div class="glass-subtitle">Your new account</div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="glass-input-group">
                    <div class="glass-label">Name</div>
                ...
                {{-- Confirm Password --}}
                <div class="glass-input-group">
                    <div class="glass-label">Confirm Password</div>
                    <div class="glass-input-wrap">
                        <input
