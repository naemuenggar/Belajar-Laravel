<x-guest-layout>
    ...
    <style>
        ...
        .glass-icon-circle {
            ...
            color: #e5e7eb;
            margin-bottom: 24px;
            background: radial-gradient(circle at top, rgba(53, 162, 235, 0.35), rgba(15, 23, 42, 0.95));
            box-shadow:
        ...
        .glass-button {
            ...
            gap: 8px;
            background:
                radial-gradient(circle at top, rgba(34, 197, 94, 0.35), rgba(15, 23, 42, 1));
            color: #e5fbea;
            box-shadow:
        ...
        .glass-button:hover {
            ...
            box-shadow:
                0 24px 60px rgba(22, 163, 74, 0.9),
        ...
        <div class="glass-card">
            <div class="glass-card-header">
                ...
                <div class="glass-tabs">
                    <span class="glass-tab-active">Login</span>
                    <a href="{{ route('register') }}" class="glass-tab-inactive">Register</a>
                </div>
            </div>

            <div class="glass-title">Sign in</div>
            <div class="glass-subtitle">Welcome back to the dashboard</div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                {{-- Password --}}
                <div class="glass-input-group" style="margin-top: 14px;">
                    <div class="glass-label">Password</div>
                    <div class="glass-input-wrap">
                        <input
                            id="password"
                            type="password"
                    ...
                    @if ($errors->has('password'))
                        <p class="input-error">{{ $errors->first('password') }}</p>
                    @endif
                </div>
